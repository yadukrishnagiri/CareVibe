...
class SurfaceOrganHealth extends StatelessWidget {
  const SurfaceOrganHealth({super.key, required this.summary, required this.metrics});
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text('Surface Organ Health', style: ProModeTypography.headlineMedium(context)),
        ),
            ...
            children: [
              _OrganCard(
                ...
                lines: [
                  ...
                  if (summary.shockIndex != null) 'SI ${summary.shockIndex!.toStringAsFixed(2)}',
                ],
              ),
              _OrganCard(
                title: 'Lungs',
                ...
                lines: [
                  ...
                  if (summary.respiratoryDistressSeverity != null) 'Distress: ${summary.respiratoryDistressSeverity}',
                ],
              ),
              _OrganCard(
                title: 'Metabolic',
              ...
              _OrganCard(
                title: 'Recovery',
                status: (summary.sleepQualityIndex.isNaN ? 'N/A' : (summary.sleepQualityIndex >= 75 ? 'GOOD' : 'LOW')),
                lines: [
              ...
              _OrganCard(
                title: 'Kidneys',
                status: 'DATA NEEDED',
                lines: const ['Add creatinine to enable eGFR'],
              ),
              _OrganCard(
                title: 'Liver',
                status: 'DATA NEEDED',
                lines: const ['Add bilirubin/INR/Na⁺ for MELD‑Na'],
              ),
            ],
          ),
        ),
        if (profile == null || profile.age == null || profile.gender == null || profile.heightCm == null)
          Padding(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: const Text('Complete your profile (age, gender, height) to enable age/sex‑aware ranges.',
...
class _OrganCard extends StatelessWidget {
  const _OrganCard({required this.title, required this.status, required this.lines});
  final String title;
  final String status;
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(title, style: const TextStyle(color: ProModeColors.textPrimary, fontWeight: FontWeight.w600)),
          ...
          for (final l in lines)
            Padding(
              ...
              child: Text(l, style: const TextStyle(color: ProModeColors.textMuted, fontSize: 12)),
            ),
        ],
      ),
    );
